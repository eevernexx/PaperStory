...
const NODES = [
  { num: "1", label: "Analisis · need + target user" },
  { num: "2", label: "Desain · marker + 3D model" },
  { num: "3", label: "Build · Unity + Vuforia" },
  { num: "4", label: "Uji · usability test" },
  { num: "5", label: "Deploy · Android APK", winner: true },
];

export default function ArMethodScene({ active }: { active: boolean }) {
  return (
    <div className="absolute inset-0 flex flex-col items-start justify-center p-5 sm:p-[40px] px-10 bg-mint overflow-y-auto">
